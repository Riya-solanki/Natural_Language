...
class DataLoader:
    ...
    def readAndAugmentSimileData(self, file_path, vocab_path, merge_info_name, vocab_name,
        ...
        print("Simile Data Saved Successfully.")

# =================== MAIN ===================
if __name__ == "__main__":
    data_extraction_task = PRE_TRAIN  # or SEM_ANLG or SIMILE

    save_path = '/content/Natural_Language/Data/'
    os.makedirs(save_path, exist_ok=True)
    vocab_path = '/content/Natural_Language/TokenizerFast'
    merge_info_name = '/content/Natural_Language/TokenizerFast/merges.txt'
    vocab_name = '/content/Natural_Language/TokenizerFast/vocab.json'
    ...
    if data_extraction_task == PRE_TRAIN:
        ...
        data_loader.extractData_MultipleDocs(file_path=file_path,
        ...
        data_loader.extract_Analogies_data(csv_path=csv_path,
                                           vocab_path=vocab_path,
                                           merge_info_name=merge_info_name,
                                           vocab_name=vocab_name)
    elif data_extraction_task == SIMILE:
        file_path = './Training_Docs/Upama Data.csv'
        data_loader.readAndAugmentSimileData(file_path=file_path,
                                            vocab_path=vocab_path,
                                            merge_info_name=merge_info_name,
                                            vocab_name=vocab_name)
