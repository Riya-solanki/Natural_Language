...
def create_train_config(
    ...
    # Dummy/default values for required file arguments (Trainer uses .pt files)
    replacements = {}
    file_name = "All Files"
    ...
    return TrainConfig(
        ...
        # Required training file parameters
        replacements=replacements,
        file_name=file_name,
        file_path=file_path,
        vocab_path=vocab_path,
        load_merge_info_name=load_merge_info_name,
...
# Format: (vocab_size, batch_size, tokens_batch_size, warmup_iters, max_lr, min_lr, train_shards, val_shard)
experiments = [
...
for idx, exp in enumerate(experiments):
    vocab_size, batch_size, tokens_batch_size, warmup_iters, max_lr, min_lr, train_shards, val_shard = exp
